...
public abstract class AtomDefinition
{
    public virtual int AtomicNumber { get; }    
    public virtual int AtomicMass { get; }
    public virtual int ProtonCount { get; }
    public virtual int ElectonCount { get; }
    public virtual int NeutronCount { get; }
}
